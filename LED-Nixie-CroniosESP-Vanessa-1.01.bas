' *************************************
' * LED-NIXIE Cronios-ESP Clock Demo  *
' *  LED-Basic >= 15.3.0 required     *
' *  modified by Vanessa Ver. 1.01    *
' *************************************
'
' Operations manual:
'
...
'
' Press Micro Key to toggle Alarm ON / OFF
'        show alarm = alarm on
'        deep beep = alarm off
'
' Settings menu (white):
...
'    IO.eewrite(0, 101)           ' 0 = Softwareversion
...
'    IO.eewrite(10, 0)            ' 10 =
'    IO.eewrite(11, 0)            ' 11 =
'    IO.eewrite(12, 12)           ' 12 = Min Auto Bright       (2)
...
' Version
    gosub 9100         ' BEEP
    LED.iled(2, 20 + read 10, 1) ' Version
    LED.iled(2, 30 + read 10, 0) ' Version
    LED.iled(2, 40 + read 10, 1) ' Version
    LED.show()
    delay 2000
'
' EEPROM INIT
    if (IO.eeread(0)) <> 101 or (IO.keystate()) <> 0 gosub 8000 'first time or reset
...
700:
    ...
    return
'....................
' micro key pressed = toggle alarm on / off
710:
    k = IO.keystate()
    delay 2
    if k <> 0 goto 710
    t = IO.eeread(5) ' Read alarm Value
    if t = 0 then t = 1 else t = 0 ' toggle alarm on / off
    IO.eewrite(5, t) ' write alarm Value
    if t = 1 goto 700 ' show alarm on
    IO.beep(15) ' alarm off
    delay 300
    IO.beep(0)
    return
'================================================
...
8000:
    ...
    IO.eewrite(10, 0)            ' 10 =
    IO.eewrite(11, 0)            ' 11 =
    IO.eewrite(12, 12)           ' 12 = Min Brightness in Auto (2)
    IO.eewrite(13, 0)            ' 13 = Slot Machine (0)
    IO.eewrite(14, 1)            ' 14 = 24 Hour Clock (1)
    IO.eewrite(15, 0)            ' 15 = Seconds flip (0)
    IO.eewrite(16, 0)            ' 16 = Date format (0)
...
9000:
    k = IO.getkey()
    if k = 0 return
    if k = 2 goto 710 ' toggle alarm on / off
    i = 0
9010:
    k = IO.keystate()
